...
const Map<String, Map<String, String>> _dict = {
  ...
  'chatbot_title': {'en': 'Help assistant', 'ar': 'مساعد المساعدة'},
  'chatbot_placeholder': {'en': 'Ask how to use MonitorFlow…', 'ar': 'اسأل كيف تستخدم MonitorFlow…'},
  'chatbot_empty': {
    'en': 'Ask me how to use any part of the app.',
    'ar': 'اسألني عن كيفية استخدام أي جزء من التطبيق.',
  },
  'chatbot_error': {"en": "Couldn't reach the assistant. Try again.", 'ar': 'تعذر الوصول إلى المساعد. حاول مرة أخرى.'},
  'chatbot_rate_limited': {
    'en': 'Too many messages — wait a few minutes.',
    'ar': 'رسائل كثيرة جدًا — انتظر بضع دقائق.',
  },
  'chatbot_suggest_clock_in': {'en': 'How do I clock in?', 'ar': 'كيف أسجل حضوري؟'},
  'chatbot_suggest_schedule': {'en': "Where's my schedule?", 'ar': 'أين جدول دوامي؟'},
  'chatbot_suggest_complete_task': {'en': 'How do I complete a task?', 'ar': 'كيف أُنهي مهمة؟'},
  'chatbot_suggest_submit_request': {'en': 'How do I submit a request?', 'ar': 'كيف أرسل طلبًا؟'},
  'chatbot_suggest_request_status': {
    'en': 'How do I check my request status?',
    'ar': 'كيف أتحقق من حالة طلبي؟',
  },
  'chatbot_suggest_what': {'en': 'What is this app?', 'ar': 'ما هو هذا التطبيق؟'},
