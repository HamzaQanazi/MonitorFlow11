...
const dict: Record<string, Loc> = {
  ...
  svc_gate_hint: {
    en: 'Oversight capability: any employee whose level grants it can fire this transition. Actor’s turn: only the request’s own requester or assignee can.',
    ar: 'صلاحية إشرافية: يمكن لأي موظف يملك هذه الصلاحية تنفيذ الانتقال. دور أحد الأطراف: فقط مُقدّم الطلب أو المُكلَّف به.',
  },
  svc_transition_flags_hint: {
    en: 'A required note is saved to the request’s timeline. The completion form only applies to a transition that finishes the work.',
    ar: 'تُحفظ الملاحظة المطلوبة في الجدول الزمني للطلب. أما نموذج الإنجاز فيخص الانتقال الذي يُنهي العمل فقط.',
  },
  svc_notify_hint: { en: 'Who gets notified when this transition fires.', ar: 'من يتم إشعاره عند تنفيذ هذا الانتقال.' },
  svc_statuses_hint: {
    en: 'Exactly one status must be Initial (where every request starts); at least one must be Terminal (locks the task, no further transitions).',
    ar: 'يجب أن تكون حالة واحدة بالضبط أولية (حيث تبدأ كل الطلبات)، وحالة واحدة على الأقل نهائية (تُقفل المهمة، ولا انتقالات بعدها).',
  },
  svc_transitions_hint: {
    en: 'A transition moves a request from one status to another, gated by either an oversight capability or whichever party’s turn it is.',
    ar: 'الانتقال ينقل الطلب من حالة إلى أخرى، ويُتحكّم به إما بصلاحية إشرافية أو بدور أحد الأطراف.',
  },
  cap_view_all: { en: 'View all requests', ar: 'عرض كل الطلبات' },
  cap_assign: { en: 'Assign requests', ar: 'إسناد الطلبات' },
  cap_set_priority: { en: 'Set priority', ar: 'تحديد الأولوية' },
  cap_override: { en: 'Override status', ar: 'تجاوز الحالة' },
  cap_manage_employees: { en: 'Manage employees', ar: 'إدارة الموظفين' },
  cap_export: { en: 'Export data', ar: 'تصدير البيانات' },
  cap_manage_events: { en: 'Manage events', ar: 'إدارة الفعاليات' },
  cap_manage_knowledge_base: { en: 'Manage knowledge base', ar: 'إدارة قاعدة المعرفة' },
  cap_manage_training: { en: 'Manage training', ar: 'إدارة التدريب' },
  actor_requester: { en: 'The requester', ar: 'مُقدّم الطلب' },
  actor_assignee: { en: 'The assignee', ar: 'المُكلَّف بالطلب' },
  notify_created_by: { en: 'The request’s creator', ar: 'مُنشئ الطلب' },
  notify_assigned_to: { en: 'The assignee', ar: 'المُكلَّف بالطلب' },
  notify_assignee_manager: { en: 'The assignee’s manager', ar: 'مدير المُكلَّف بالطلب' },
