...
const dict: Record<string, Loc> = {
  ...
  chatbot_open: { en: 'Open help assistant', ar: 'فتح مساعد المساعدة' },
  chatbot_close: { en: 'Close', ar: 'إغلاق' },
  chatbot_placeholder: { en: 'Ask how to use MonitorFlow…', ar: 'اسأل كيف تستخدم MonitorFlow…' },
  chatbot_send: { en: 'Send', ar: 'إرسال' },
  chatbot_empty: { en: 'Ask me how to use any part of the app.', ar: 'اسألني عن كيفية استخدام أي جزء من التطبيق.' },
  chatbot_error: { en: "Couldn't reach the assistant. Try again.", ar: 'تعذر الوصول إلى المساعد. حاول مرة أخرى.' },
  chatbot_rate_limited: { en: 'Too many messages — wait a few minutes.', ar: 'رسائل كثيرة جدًا — انتظر بضع دقائق.' },
  chatbot_suggest_setup: { en: 'How do I set up my company?', ar: 'كيف أُعِدّ شركتي؟' },
  chatbot_suggest_what: { en: 'What is this app?', ar: 'ما هو هذا التطبيق؟' },
  chatbot_suggest_employee: { en: 'How do I add an employee?', ar: 'كيف أضيف موظفًا؟' },
  chatbot_suggest_assign: { en: 'How do I assign a request?', ar: 'كيف أُسنِد طلبًا؟' },
  ...
  detail_internal_chat: { en: 'Internal chat', ar: 'المحادثة الداخلية' },
  detail_internal_chat_hint: {
    en: 'Visible to this request’s assignees and department oversight only — never the requester.',
    ar: 'مرئية فقط للموظفين المُسندين لهذا الطلب والإشراف في الدائرة — وليس لمقدّم الطلب.',
  },
  detail_no_internal_comments: { en: 'No internal messages yet.', ar: 'لا رسائل داخلية بعد.' },
  detail_write_internal_comment_aria: { en: 'Write an internal message', ar: 'اكتب رسالة داخلية' },
  detail_write_internal_comment_ph: { en: 'Message the crew…', ar: 'راسل الفريق…' },
  detail_post_internal_comment: { en: 'Post message', ar: 'نشر الرسالة' },
  detail_internal_comment_fail: { en: 'Couldn’t post the message.', ar: 'تعذّر نشر الرسالة.' },
  ...
  tc_tab_livemap: { en: 'Live Map', ar: 'الخريطة المباشرة' },
  tc_live_hint: {
    en: 'Shows employees currently clocked in, updated every 5 minutes. Location stops the moment someone clocks out.',
    ar: 'يعرض الموظفين المسجَّلين حاليًا، ويُحدَّث كل 5 دقائق. يتوقف الموقع فور تسجيل الانصراف.',
  },
  tc_live_none_h: { en: 'No one is clocked in', ar: 'لا أحد مسجَّل حضوره حاليًا' },
  tc_live_none_p: { en: 'Employees appear here while they have an active shift.', ar: 'يظهر الموظفون هنا أثناء وجود دوام نشط لهم.' },
  tc_live_no_fix_h: { en: 'No location received yet', ar: 'لم يُستلم أي موقع بعد' },
  tc_live_no_fix_footnote: { en: 'clocked in, waiting for their first location ping.', ar: 'مسجَّل حضوره، بانتظار أول إشارة موقع.' },
  tc_live_just_now: { en: 'just now', ar: 'الآن' },
  tc_live_min_ago: { en: 'm ago', ar: 'د مضت' },
  tc_live_hr_ago: { en: 'h ago', ar: 'س مضت' },
