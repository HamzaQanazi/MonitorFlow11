...
const dict: Record<string, Loc> = {
  ...
  audit_act_created: { en: 'Employee created', ar: 'إنشاء موظف' },
  audit_act_updated: { en: 'Employee updated', ar: 'تعديل موظف' },
  audit_act_activated: { en: 'Employee activated', ar: 'تفعيل موظف' },
  audit_act_deactivated: { en: 'Employee deactivated', ar: 'إلغاء تفعيل موظف' },
  audit_act_password_reset: { en: 'Employee password reset', ar: 'إعادة تعيين كلمة مرور موظف' },
  audit_act_status_changed: { en: 'Status changed', ar: 'تغيير الحالة' },
  audit_act_assigned: { en: 'Request assigned', ar: 'إسناد الطلب' },
  audit_act_priority_changed: { en: 'Priority changed', ar: 'تغيير الأولوية' },
